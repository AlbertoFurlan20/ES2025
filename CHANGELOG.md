...
Verified on hardware: runs 3 and 4 in
[`E_analysis/BASELINE.md`](E_analysis/BASELINE.md) reproduce the 1.1.0 timing
columns bit-for-bit, with zero drops, errors or malformed lines.
...
- **A capture passed the R2 acceptance gate with B1 fully unfixed.** Run 3 is
  ...
  certified an unfixed defect as repaired. The two-run requirement in
  `BASELINE.md` was written on theoretical grounds; it now has a worked
